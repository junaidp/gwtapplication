...
public class CenterPanelsView extends FlowPanel {
    ...
    private static CenterPanelsViewUiBinder uiBinder = GWT.create(CenterPanelsViewUiBinder.class);

    interface CenterPanelsViewUiBinder extends UiBinder<Widget, CenterPanelsView> {
    }
