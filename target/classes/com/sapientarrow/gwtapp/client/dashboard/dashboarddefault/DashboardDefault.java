...
import com.sapientarrow.gwtapp.client.dashboard.dashboarddefault.DashboardDefaultPresenter.Display;

//This class is a View for Dashboard  on the main screen
public class DashboardDefault extends Composite implements Display {

    private static DashboardViewUiBinder uiBinder = GWT.create(DashboardViewUiBinder.class);

    interface DashboardViewUiBinder extends UiBinder<Widget, DashboardDefault> {
    }
