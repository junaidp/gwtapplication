...
public class TemplateGreenPresenter implements Presenter

{
    ...
    public TemplateGreenPresenter(HelloServiceAsync rpcService, HandlerManager eventBus, Display view,
	    UserEntity user) {
	this.display = view;
