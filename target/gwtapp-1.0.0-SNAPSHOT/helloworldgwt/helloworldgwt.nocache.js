function helloworldgwt(){
  ...
  $stats && $stats({moduleName:'helloworldgwt', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'begin'});
  ...
  function maybeStartModule(){
    if (scriptsDone && loadDone) {
      var iframe = $doc_0.getElementById('helloworldgwt');
      ...
      helloworldgwt = null;
      frameWnd.gwtOnLoad(onLoadErrorFunc, 'helloworldgwt', base, softPermutationId);
      $stats && $stats({moduleName:'helloworldgwt', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'end'});
    }
  }
  ...
  function computeScriptBase(){
    ...
    function tryNocacheJsTag(){
      ...
      for (var i = 0; i < scriptTags.length; ++i) {
        if (scriptTags[i].src.indexOf('helloworldgwt.nocache.js') != -1) {
    ...
    function tryMarkerScript(){
      ...
      if (typeof isBodyLoaded == 'undefined' || !isBodyLoaded()) {
        var markerId = '__gwt_marker_helloworldgwt';
        var markerScript;
  ...
  function processMetas(){
    ...
    for (var i = 0, n = metas.length; i < n; ++i) {
      ...
      if (name_0) {
        name_0 = name_0.replace('helloworldgwt::', '');
        if (name_0.indexOf('::') >= 0) {
          continue;
        }
  ...
  function maybeInjectFrame(){
    if (!frameInjected) {
      ...
      iframe.id = 'helloworldgwt';
      iframe.style.cssText = 'position:absolute;width:0;height:0;border:none';
      iframe.tabIndex = -1;
      $doc_0.body.appendChild(iframe);
      $stats && $stats({moduleName:'helloworldgwt', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'moduleRequested'});
  ...
  helloworldgwt.onInjectionDone = function(){
    scriptsDone = true;
    $stats && $stats({moduleName:'helloworldgwt', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'end'});
    maybeStartModule();
  }
  ;
  processMetas();
  ...
  var initialHtml;
  if (isHostedMode()) {
    if ($wnd_0.external && ($wnd_0.external.initModule && $wnd_0.external.initModule('helloworldgwt'))) {
      $wnd_0.location.reload();
      return;
    }
    initialHtml = 'hosted.html?helloworldgwt';
    strongName = '';
  }
  $stats && $stats({moduleName:'helloworldgwt', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'selectingPermutation'});
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers(['safari'], '4689A2B7394EC79C62E66A0FAF458CE3');
      unflattenKeylistIntoAnswers(['ie9'], '97A369545320CACB95CEEE0DFBD151BD');
      unflattenKeylistIntoAnswers(['gecko1_8'], 'C07AC308A136C1B41DA09F7A3962AA11');
      unflattenKeylistIntoAnswers(['ie10'], 'EBBA2F3420215B8ADD72EA7AB9DDBBE4');
      unflattenKeylistIntoAnswers(['ie8'], 'F1F79E6D42B74C74D481ED3714ABA544');
  ...
  , 50);
  $stats && $stats({moduleName:'helloworldgwt', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'end'});
  $stats && $stats({moduleName:'helloworldgwt', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'begin'});
  ...
  $doc_0.write('<script defer="defer">helloworldgwt.onInjectionDone(\'helloworldgwt\')<\/script>');
}
