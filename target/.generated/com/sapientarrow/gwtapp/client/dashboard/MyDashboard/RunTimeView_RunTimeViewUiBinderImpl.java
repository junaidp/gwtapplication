...
public class RunTimeView_RunTimeViewUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.sapientarrow.gwtapp.client.dashboard.MyDashboard.RunTimeView>, com.sapientarrow.gwtapp.client.dashboard.MyDashboard.RunTimeView.RunTimeViewUiBinder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.sapientarrow.gwtapp.client.dashboard.MyDashboard.RunTimeView owner) {
   ...
   */
  class Widgets {
    private final com.sapientarrow.gwtapp.client.dashboard.MyDashboard.RunTimeView owner;


    public Widgets(final com.sapientarrow.gwtapp.client.dashboard.MyDashboard.RunTimeView owner) {
      this.owner = owner;
     ...
     */
    private com.sapientarrow.gwtapp.client.dashboard.MyDashboard.RunTimeView_RunTimeViewUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.sapientarrow.gwtapp.client.dashboard.MyDashboard.RunTimeView_RunTimeViewUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.sapientarrow.gwtapp.client.dashboard.MyDashboard.RunTimeView_RunTimeViewUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.sapientarrow.gwtapp.client.dashboard.MyDashboard.RunTimeView_RunTimeViewUiBinderImpl_GenBundle) GWT.create(com.sapientarrow.gwtapp.client.dashboard.MyDashboard.RunTimeView_RunTimeViewUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private com.sapientarrow.gwtapp.client.dashboard.MyDashboard.RunTimeView_RunTimeViewUiBinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private com.sapientarrow.gwtapp.client.dashboard.MyDashboard.RunTimeView_RunTimeViewUiBinderImpl_GenCss_style build_style() {
      // Creation section.
      final com.sapientarrow.gwtapp.client.dashboard.MyDashboard.RunTimeView_RunTimeViewUiBinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_container() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord138 = UiBinderUtil.attachToDom(container.getElement());
      get_domId0Element().get();
      get_domId1Element().get();

      // Detach section.
      attachRecord138.detach();
    ...
    private com.google.gwt.user.client.ui.Label build_f_Label1() {
      ...
      // Setup section.
      f_Label1.setText("Run time Details");
