...
public class MyAccountPanel_MyAccountViewUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.sapientarrow.gwtapp.client.dashboard.MyDashboard.MyAccountPanel>, com.sapientarrow.gwtapp.client.dashboard.MyDashboard.MyAccountPanel.MyAccountViewUiBinder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.sapientarrow.gwtapp.client.dashboard.MyDashboard.MyAccountPanel owner) {
   ...
   */
  class Widgets {
    private final com.sapientarrow.gwtapp.client.dashboard.MyDashboard.MyAccountPanel owner;


    public Widgets(final com.sapientarrow.gwtapp.client.dashboard.MyDashboard.MyAccountPanel owner) {
      this.owner = owner;
     ...
     */
    private com.sapientarrow.gwtapp.client.dashboard.MyDashboard.MyAccountPanel_MyAccountViewUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.sapientarrow.gwtapp.client.dashboard.MyDashboard.MyAccountPanel_MyAccountViewUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.sapientarrow.gwtapp.client.dashboard.MyDashboard.MyAccountPanel_MyAccountViewUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.sapientarrow.gwtapp.client.dashboard.MyDashboard.MyAccountPanel_MyAccountViewUiBinderImpl_GenBundle) GWT.create(com.sapientarrow.gwtapp.client.dashboard.MyDashboard.MyAccountPanel_MyAccountViewUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private com.sapientarrow.gwtapp.client.dashboard.MyDashboard.MyAccountPanel_MyAccountViewUiBinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private com.sapientarrow.gwtapp.client.dashboard.MyDashboard.MyAccountPanel_MyAccountViewUiBinderImpl_GenCss_style build_style() {
      // Creation section.
      final com.sapientarrow.gwtapp.client.dashboard.MyDashboard.MyAccountPanel_MyAccountViewUiBinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_container() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord136 = UiBinderUtil.attachToDom(container.getElement());
      get_domId0Element().get();
      get_domId1Element().get();

      // Detach section.
      attachRecord136.detach();
    ...
    private com.google.gwt.user.client.ui.Label build_f_Label1() {
      ...
      // Setup section.
      f_Label1.setText("My Account Details");
