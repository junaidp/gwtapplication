...
public class TableRes_default_InlineClientBundleGenerator implements com.sapientarrow.gwtapp.client.view.TableRes {
  private static TableRes_default_InlineClientBundleGenerator _instance0 = new TableRes_default_InlineClientBundleGenerator();
  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.sapientarrow.gwtapp.client.view.TableRes.TableStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GBDND-TCMI{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GBDND-TCNI{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GBDND-TCGI{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GBDND-TCLJ{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GBDND-TCLJ:hover{color:" + ("#6c6b6b")  + ";}.GBDND-TCHI{background:" + ("#fff")  + ";}.GBDND-TCII{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GBDND-TCHJ{background:" + ("#f3f7fb")  + ";}.GBDND-TCIJ{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GBDND-TCOI{background:" + ("#eee")  + ";}.GBDND-TCPI{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GBDND-TCBJ{background:" + ("#ffc")  + ";}.GBDND-TCCJ{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GBDND-TCJJ{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GBDND-TCKJ{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GBDND-TCAJ{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GBDND-TCGJ{margin:") + (("30px")  + ";}.GBDND-TCNI{padding:" + ("0")  + ";color:" + ("#545454")  + ";text-align:" + ("center")  + ";font-size:" + ("13px")  + ";background-image:" + ("none")  + ";background-color:" + ("#e5e4e2")  + ";height:" + ("25px")  + ";vertical-align:" + ("middle")  + ";font-weight:" + ("bold")  + ";text-shadow:" + ("0"+ " " +"1px"+ " " +"1px"+ " " +"rgba(" + "255"+ ","+ " " +"255"+ ","+ " " +"255"+ ","+ " " +"0.7" + ")") ) + (";border:" + ("1px")  + ";}.GBDND-TCGI{border:" + ("12px")  + ";border-width:" + ("12px")  + ";border-color:" + ("red")  + ";}")) : ((".GBDND-TCMI{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GBDND-TCNI{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GBDND-TCGI{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GBDND-TCLJ{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GBDND-TCLJ:hover{color:" + ("#6c6b6b")  + ";}.GBDND-TCHI{background:" + ("#fff")  + ";}.GBDND-TCII{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GBDND-TCHJ{background:" + ("#f3f7fb")  + ";}.GBDND-TCIJ{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GBDND-TCOI{background:" + ("#eee")  + ";}.GBDND-TCPI{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GBDND-TCBJ{background:" + ("#ffc")  + ";}.GBDND-TCCJ{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GBDND-TCJJ{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GBDND-TCKJ{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GBDND-TCAJ{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GBDND-TCGJ{margin:") + (("30px")  + ";}.GBDND-TCNI{padding:" + ("0")  + ";color:" + ("#545454")  + ";text-align:" + ("center")  + ";font-size:" + ("13px")  + ";background-image:" + ("none")  + ";background-color:" + ("#e5e4e2")  + ";height:" + ("25px")  + ";vertical-align:" + ("middle")  + ";font-weight:" + ("bold")  + ";text-shadow:" + ("0"+ " " +"1px"+ " " +"1px"+ " " +"rgba(" + "255"+ ","+ " " +"255"+ ","+ " " +"255"+ ","+ " " +"0.7" + ")") ) + (";border:" + ("1px")  + ";}.GBDND-TCGI{border:" + ("12px")  + ";border-width:" + ("12px")  + ";border-color:" + ("red")  + ";}"));
      }
  ...
  private static class cellTableStyleInitializer {
    ...
    static com.sapientarrow.gwtapp.client.view.TableRes.TableStyle get() {
      return cellTableStyle;
    }
  }
  public com.sapientarrow.gwtapp.client.view.TableRes.TableStyle cellTableStyle() {
  ...
  private static com.sapientarrow.gwtapp.client.view.TableRes.TableStyle cellTableStyle;
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      ...
      case 'cellTableStyle': return this.@com.sapientarrow.gwtapp.client.view.TableRes::cellTableStyle()();
    }
    return null;
  }-*/;
}
