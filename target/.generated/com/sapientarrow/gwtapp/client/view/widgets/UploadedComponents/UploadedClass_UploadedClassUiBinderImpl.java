...
public class UploadedClass_UploadedClassUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.sapientarrow.gwtapp.client.view.widgets.UploadedComponents.UploadedClass>, com.sapientarrow.gwtapp.client.view.widgets.UploadedComponents.UploadedClass.UploadedClassUiBinder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.sapientarrow.gwtapp.client.view.widgets.UploadedComponents.UploadedClass owner) {
   ...
   */
  class Widgets {
    private final com.sapientarrow.gwtapp.client.view.widgets.UploadedComponents.UploadedClass owner;
    ...
    public Widgets(final com.sapientarrow.gwtapp.client.view.widgets.UploadedComponents.UploadedClass owner) {
      this.owner = owner;
     ...
     */
    private com.sapientarrow.gwtapp.client.view.widgets.UploadedComponents.UploadedClass_UploadedClassUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.sapientarrow.gwtapp.client.view.widgets.UploadedComponents.UploadedClass_UploadedClassUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.sapientarrow.gwtapp.client.view.widgets.UploadedComponents.UploadedClass_UploadedClassUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.sapientarrow.gwtapp.client.view.widgets.UploadedComponents.UploadedClass_UploadedClassUiBinderImpl_GenBundle) GWT.create(com.sapientarrow.gwtapp.client.view.widgets.UploadedComponents.UploadedClass_UploadedClassUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private com.sapientarrow.gwtapp.client.view.widgets.UploadedComponents.UploadedClass_UploadedClassUiBinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private com.sapientarrow.gwtapp.client.view.widgets.UploadedComponents.UploadedClass_UploadedClassUiBinderImpl_GenCss_style build_style() {
      // Creation section.
      final com.sapientarrow.gwtapp.client.view.widgets.UploadedComponents.UploadedClass_UploadedClassUiBinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord140 = UiBinderUtil.attachToDom(f_HTMLPanel1.getElement());
