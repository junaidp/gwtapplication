...
public class ViewRegistrationDetails_ViewRegistrationDetailsUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.sapientarrow.gwtapp.client.globalpreferences.myaccountpreferences.ViewRegistrationDetails>, com.sapientarrow.gwtapp.client.globalpreferences.myaccountpreferences.ViewRegistrationDetails.ViewRegistrationDetailsUiBinder {
  ...
  interface Template extends SafeHtmlTemplates {
    ...
    @Template("Last time edited")
    SafeHtml html6();
     
    @Template("Allow Edidting")
    SafeHtml html7();
     
    @Template("<div style='padding-left:40%'> <h4 class='text-light blue'>View Registration</h4>  <span id='{0}'></span> </div> <div style='padding-left:5px; padding-top:5px'> <span id='{1}'></span> </div> <div style='padding-left:5px; padding-top:5px'> <span id='{2}'></span> </div> <div style='padding-left:5px; padding-top:5px'> <span id='{3}'></span> </div> <div style='padding-left:5px; padding-top:5px'> <span id='{4}'></span> </div> <div style='padding-left:5px; padding-top:5px'> <span id='{5}'></span> </div> <div style='padding-left:10px'> <span id='{6}'></span> </div>")
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.sapientarrow.gwtapp.client.globalpreferences.myaccountpreferences.ViewRegistrationDetails owner) {
   ...
   */
  class Widgets {
    private final com.sapientarrow.gwtapp.client.globalpreferences.myaccountpreferences.ViewRegistrationDetails owner;


    public Widgets(final com.sapientarrow.gwtapp.client.globalpreferences.myaccountpreferences.ViewRegistrationDetails owner) {
      this.owner = owner;
     ...
     */
    private com.sapientarrow.gwtapp.client.globalpreferences.myaccountpreferences.ViewRegistrationDetails_ViewRegistrationDetailsUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.sapientarrow.gwtapp.client.globalpreferences.myaccountpreferences.ViewRegistrationDetails_ViewRegistrationDetailsUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.sapientarrow.gwtapp.client.globalpreferences.myaccountpreferences.ViewRegistrationDetails_ViewRegistrationDetailsUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.sapientarrow.gwtapp.client.globalpreferences.myaccountpreferences.ViewRegistrationDetails_ViewRegistrationDetailsUiBinderImpl_GenBundle) GWT.create(com.sapientarrow.gwtapp.client.globalpreferences.myaccountpreferences.ViewRegistrationDetails_ViewRegistrationDetailsUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private com.sapientarrow.gwtapp.client.globalpreferences.myaccountpreferences.ViewRegistrationDetails_ViewRegistrationDetailsUiBinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private com.sapientarrow.gwtapp.client.globalpreferences.myaccountpreferences.ViewRegistrationDetails_ViewRegistrationDetailsUiBinderImpl_GenCss_style build_style() {
      // Creation section.
      final com.sapientarrow.gwtapp.client.globalpreferences.myaccountpreferences.ViewRegistrationDetails_ViewRegistrationDetailsUiBinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord178 = UiBinderUtil.attachToDom(f_HTMLPanel1.getElement());
      ...
      f_HTMLPanel1.addAndReplaceElement(get_checkLastTimeEdited(), get_domId5Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_checkAllowEditing(), get_domId6Element().get());
    ...
    /**
     * Getter for checkLastTimeEdited called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.client.ui.CheckBox get_checkLastTimeEdited() {
      return build_checkLastTimeEdited();
    }
    private com.google.gwt.user.client.ui.CheckBox build_checkLastTimeEdited() {
      // Creation section.
      final com.google.gwt.user.client.ui.CheckBox checkLastTimeEdited = (com.google.gwt.user.client.ui.CheckBox) GWT.create(com.google.gwt.user.client.ui.CheckBox.class);
      // Setup section.
      checkLastTimeEdited.setHTML(template_html6().asString());


      this.owner.checkLastTimeEdited = checkLastTimeEdited;
    ...
    /**
     * Getter for checkAllowEditing called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.client.ui.CheckBox get_checkAllowEditing() {
      return build_checkAllowEditing();
    }
    private com.google.gwt.user.client.ui.CheckBox build_checkAllowEditing() {
      // Creation section.
      final com.google.gwt.user.client.ui.CheckBox checkAllowEditing = (com.google.gwt.user.client.ui.CheckBox) GWT.create(com.google.gwt.user.client.ui.CheckBox.class);
      // Setup section.
      checkAllowEditing.setHTML(template_html7().asString());
      checkAllowEditing.setVisible(false);


      this.owner.checkAllowEditing = checkAllowEditing;
