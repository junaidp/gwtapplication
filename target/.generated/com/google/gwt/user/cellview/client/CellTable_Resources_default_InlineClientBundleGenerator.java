  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.google.gwt.user.cellview.client.CellTable.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GBDND-TCED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GBDND-TCFD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GBDND-TCOC{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GBDND-TCDE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GBDND-TCDE:hover{color:" + ("#6c6b6b")  + ";}.GBDND-TCPC{background:" + ("#fff")  + ";}.GBDND-TCAD{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GBDND-TCPD{background:" + ("#f3f7fb")  + ";}.GBDND-TCAE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GBDND-TCGD{background:" + ("#eee")  + ";}.GBDND-TCHD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GBDND-TCJD{background:" + ("#ffc")  + ";}.GBDND-TCKD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GBDND-TCBE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GBDND-TCCE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GBDND-TCID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GBDND-TCOD{margin:") + (("30px")  + ";}")) : ((".GBDND-TCED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GBDND-TCFD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GBDND-TCOC{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GBDND-TCDE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GBDND-TCDE:hover{color:" + ("#6c6b6b")  + ";}.GBDND-TCPC{background:" + ("#fff")  + ";}.GBDND-TCAD{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GBDND-TCPD{background:" + ("#f3f7fb")  + ";}.GBDND-TCAE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GBDND-TCGD{background:" + ("#eee")  + ";}.GBDND-TCHD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GBDND-TCJD{background:" + ("#ffc")  + ";}.GBDND-TCKD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GBDND-TCBE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GBDND-TCCE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GBDND-TCID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GBDND-TCOD{margin:") + (("30px")  + ";}"));
      }
