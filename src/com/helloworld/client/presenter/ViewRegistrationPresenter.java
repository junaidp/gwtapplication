...

{
	...
	public interface Display 
	{
		...
		Button getBtnUpdate();
		void updateUIFields(MyAccountEntity myAccountEntity);
		void updateEntity(MyAccountEntity myAccountEntity);
	}  
	...
	public void go(HasWidgets container) 
	{
		...
		bind();
		setHandlers();
		display.updateUIFields(loggedInUser.getMyAccountId());
	...
	public void setHandlers() {
		...
		display.getBtnUpdate().addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				 display.updateEntity(loggedInUser.getMyAccountId());
				 updateMyAccountInDb();
			}
